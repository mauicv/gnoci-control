import click
import os
from peripherals.gnoci.functions import move_robot
...
def start(ctx, update_interval, sensor_only):
    from peripherals.gnoci.setup import setup_gnoci_control
    # from peripherals.gnoci.setup import setup_gnoci_sensor
